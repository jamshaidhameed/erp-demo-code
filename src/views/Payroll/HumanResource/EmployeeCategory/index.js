...
import EmployeeCategoriesFormModal from './Components/employeeCategoriesFormModal';
...
const EmployeeCategories = () => {
  ...
  const code_length = 2;
  const { getList, deleteRecords, submitRecord, invalidateList } = useHREmployeeCategoriesQuery();
  ...
  return (
    <>
      ...
      <SubHeader name="Employee Categories" buttons={buttons} />
